...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/misty-waterfall-08e1
```

A live public deployment of this template is available at [https://misty-waterfall-08e1.templates.workers.dev](https://misty-waterfall-08e1.templates.workers.dev)
